    ...
    <main>
      <header>
        <div class="max-w-xl md:max-w-3xl xl:max-w-4xl flex flex-col-reverse mx-auto text-center px-6 pt-24 pb-10 md:py-32 border-b border-gray-300 dark:border-gray-600">
          <h1 class="text-4xl sm:text-5xl md:text-6xl font-caption font-bold mb-2 capitalize dark:text-teal-200">{{ titleCase($page.author.title) }}</h1>
        ...
        <nav class="absolute top-0 left-0 z-20 mt-6 ml-6">
          <g-link to="/" class="text-sm border text-gray-900 dark:text-gray-300 border-gray-400 opacity-75 hover:opacity-100 rounded-full px-4 py-2 transition-opacity duration-300">&larr; Volver a la portada</g-link>
        </nav>
      </header>
      <section>
